...
const STATUS_COPY = {
  zh: {
    ...
    listening: { label: "就绪", title: "按住左 Shift 开始说话", detail: "松开后自动转写并输入到当前光标位置。", tone: "ok" },
  ...
  en: {
    ...
    listening: { label: "Ready", title: "Hold Left Shift to speak", detail: "Release to transcribe and type at the current cursor.", tone: "ok" },
...
const COPY = {
  zh: {
    ...
    statusDockHint: "左 Shift 说话，左 Option 进行 AI 编辑，双击左 Shift 切换润色模式",
    shortcutSpeak: "开始说话",
  ...
  en: {
    ...
    statusDockHint: "Left Shift to speak, Left Option for AI editing, double Left Shift to switch polish mode",
...
const EMPTY_SETTINGS = {
  ...
  audio: { mode: "ptt", device: "auto", vad_aggressiveness: 2, ptt_key: "shift_l", ai_key: "alt_l" },
...
export default function App() {
  ...
  const pttKey = settings.audio?.ptt_key || "shift_l";
  const aiKey = settings.audio?.ai_key || "alt_l";
